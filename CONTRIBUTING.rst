...
.. _user-docs: https://github.com/tallybark/easy-as-pypi-termio/tree/release/docs
...
Report bugs at https://github.com/tallybark/easy-as-pypi-termio/issues.
...
the `README
<https://github.com/tallybark/easy-as-pypi-termio/blob/release/README.rst>`__,
and the inline docstrings that generate the `API documentation
<https://easy-as-pypi-termio.readthedocs.io/en/latest/modules.html>`__
...
https://github.com/tallybark/easy-as-pypi-termio/issues.
...
Ready to contribute? Here's how to set up |easy-as-pypi-termio|_
for local development.

1. Fork the |easy-as-pypi-termio|_ repo on GitHub.

   * Visit `<https://github.com/tallybark/easy-as-pypi-termio>`__
     and click *Fork*.
...
2. Clone your fork locally.
   ...
   and run the command::
    ...
    $ git clone git@github.com:<your_login>/easy-as-pypi-termio.git

3. Install |easy-as-pypi-termio|_ into a Python virtual instance,
   or |virtualenv|_.
   ...
   Next, set up a virtual environment for local development::
    ...
    $ mkvirtualenv -a $(pwd) easy-as-pypi-termio
    (easy-as-pypi-termio) $

   *Note:* We use the ``-a`` option so that ``cdproject`` changes directories
   to the ``easy-as-pypi-termio/`` directory when we're in the virtual
   environment.

   Next, set up your fork for local development::

    (easy-as-pypi-termio) $ cdproject
...
4. Before starting work on a new feature or bug fix, make sure your
   ``develop`` branch is up to date with the official branch::
    ...
    (easy-as-pypi-termio) $ cdproject
    (easy-as-pypi-termio) $ git remote add upstream git@github.com:tallybark/easy-as-pypi-termio.git
    (easy-as-pypi-termio) $ git fetch upstream
    (easy-as-pypi-termio) $ git checkout develop
    (easy-as-pypi-termio) $ git rebase upstream/develop
    (easy-as-pypi-termio) $ git push origin HEAD
...
10. Finally,
    ...
    <https://github.com/tallybark/easy-as-pypi-termio/pulls>`_
...
1. You can lint the code easily with one command.
   ...
   .. code-block:: Bash
      ...
      $ flake8 setup.py easy_as_pypi_termio/ tests/
...
** 🐬 Happy 🐠 easy-as-pypi-termio 🦖 Hacking!! 🐡 **
