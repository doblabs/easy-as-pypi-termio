...
# Path to package and dependency source code clones, necessary
# if you want to run `make editables && make develop` to setup
...
# docs/ subdir wherein to create docs HTML, e.g.,
